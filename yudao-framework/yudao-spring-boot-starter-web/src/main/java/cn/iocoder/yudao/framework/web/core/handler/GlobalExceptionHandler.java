...
public class GlobalExceptionHandler {
    ...
    private CommonResult<?> handleTableNotExists(Throwable ex) {
        ...
        if (message.contains("report_")) {
            log.error("[商城系统 yudao-module-report - 报错]{}",message, ex);
        ...
        if (message.contains("bpm_")) {
            log.error("[商城系统 yudao-module-bpm - 报错]{}",message, ex);
        ...
        if (message.contains("mp_")) {
            log.error("[商城系统 yudao-module-mp - 报错]{}",message, ex);
        ...
        if (StrUtil.containsAny(message, "product_", "promotion_", "trade_")) {
            log.error("[商城系统 yudao-module-mall - 报错]{}",message, ex);
            return CommonResult.error(NOT_IMPLEMENTED.getCode(), message);

        }
        // 5. 支付平台
        if (message.contains("pay_")) {
            log.error("[商城系统 yudao-module-pay - 报错]{}",message, ex);
            return CommonResult.error(NOT_IMPLEMENTED.getCode(), message);
        }
        return null;
    }
